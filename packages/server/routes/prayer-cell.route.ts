...
router.get('/', [validate(PrayerCellQuerySchema, 'query'), paginate], prayerCellController.getPrayerCells);
router.post('/', [validate(PrayerCellCreateSchema, 'body')], prayerCellController.createPrayerCell);
