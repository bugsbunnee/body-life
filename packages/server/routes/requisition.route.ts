...
router.get('/', [auth, protectedRoute(DEFAULT_ROLES), paginate, validate(RequisitionQuerySchema, 'query')], requisitionsController.getRequisitions);
router.post('/', [auth, protectedRoute(DEFAULT_ROLES), validate(RequisitionCreateSchema, 'body')], requisitionsController.createRequisition);
