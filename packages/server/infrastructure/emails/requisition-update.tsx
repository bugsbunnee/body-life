...
export interface RequisitionUpdateProps {
...
const RequisitionUpdateEmail: React.FC<RequisitionUpdateProps> = ({ amount, description, requesterFirstName, requesterDepartmentName, status, userFirstName }) => {
   return (
      <Html>
         <Head />
         <Preview>Requisition Request Update!</Preview>
         <Tailwind>
            <Body className="bg-[#f2f2f2] py-[16px] w-full h-full font-sans">
               <Container className="bg-white p-[64px] h-full">
                  <Section className="">
                     ...
                     <Heading style={header}>An Update on Your Requisition Request</Heading>
                  </Section>
                  ...
                  <Section className="mt-[48px]">
                     ...
                     <Text className="mt-[8px]" style={body}>
                        We have an update on your requisition request. It has been <strong>{status}</strong>
                     </Text>

                     <Button className="py-[8px] px-[16px]" href={FRONTEND_BASE_URL + '/dashboard/requisitions'} style={trackOrder}>
                        View More Details
                     </Button>
                  ...
                  <Section className="mt-[16px]">
                     <Text style={header}>Requisition Details</Text>

                     <Section style={productSection}>
                        <table style={table}>
                           <thead>
                              <tr>
                                 <th style={tableHeaderColumn}>Requested By</th>
                                 <th style={tableHeaderColumn}>Amount</th>
                                 <th style={tableHeaderColumn}>Department</th>
                                 <th style={tableHeaderColumn}>Description</th>
                           ...
                           <tbody>
                              <tr>
                                 <td style={tableBodyColumn}>
                                    <Text style={productText}>{requesterFirstName}</Text>
                                 </td>

                                 <td style={tableBodyColumn}>
                                    <Text style={productText}>{amount}</Text>
                                 </td>

                                 <td style={tableBodyColumn}>
                                    <Text style={productText}>{requesterDepartmentName}</Text>
                                 </td>

                                 <td style={tableBodyColumn}>
                                    <Text style={productText}>{description}</Text>
                                 </td>

                                 <td style={tableBodyColumn}>
                                    <Text style={productText}>{status}</Text>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
...
export default RequisitionUpdateEmail;
