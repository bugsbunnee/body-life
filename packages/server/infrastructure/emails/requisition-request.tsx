...
export interface RequisitionRequestProps {
...
const RequisitionRequestEmail: React.FC<RequisitionRequestProps> = ({ amount, description, requesterFirstName, requesterDepartmentName, userFirstName }) => {
   return (
      <Html>
         <Head />
         <Preview>New Requisition Request!</Preview>
         <Tailwind>
            <Body className="bg-[#f2f2f2] py-[16px] w-full h-full font-sans">
               <Container className="bg-white p-[64px] h-full">
                  <Section className="">
                     ...
                     <Heading style={header}>New Requisition Request!!!</Heading>
                  </Section>
                  ...
                  <Section className="mt-[48px]">
                     ...
                     <Text className="mt-[8px]" style={body}>
                        A new requisition request has been submitted for your approval.
                     </Text>
...
export default RequisitionRequestEmail;
